...
sick.SoundId = "rbxassetid://169360242"
sick.Looped = true
sick.Pitch = 0.6
sick.Volume = 1
sick:Play()
...
Sky.MoonTextureId = "rbxassetid://134722779"
...
local HandlePart = CreatePart(3, Weapon, "Neon", 0, 0, "New Yeller", "Handle", VT(0.2, 3.39, 1.61),false)
local HandleMesh = CreateMesh("SpecialMesh", HandlePart, "FileMesh", "28937301", "28937670", VT(1,1,1), VT(0, 0, 0))
...
local SKILL1FRAME = CreateFrame(WEAPONGUI, 0.5, 2, UD2(0.13, 0, 0.80, 0), UD2(0.26, 0, 0.07, 0), C3(255, 255, 0), C3(255,255,0), "Skill 1 Frame")
local SKILL2FRAME = CreateFrame(WEAPONGUI, 0.5, 2, UD2(0.60, 0, 0.80, 0), UD2(0.26, 0, 0.07, 0), C3(255, 255, 0), C3(255,255,0), "Skill 2 Frame")
...
local SKILL2TEXT = CreateLabel(SKILL2FRAME, "[B] Speedup", SKILLTEXTCOLOR, 8, "Antique", 0, 2, 1, "Text 2")
...
asd.Color = ColorSequence.new(Color3.new(255, 255, 0), Color3.new(.1, 0, 0))
asd.LightEmission = .1
...
function Ragdoll(Character2,CharTorso)
	...
	local BLOOD = CreatePart(3, DummyHead, "Neon", 0, 0, "New Yeller", "Blood", VT(0.65,0.25,0.65),false)
	BLOOD.CFrame = DummyHead.CFrame*CF(0,-DummyHead.Size.Y/2,0)
	MakeForm(BLOOD,"Cyl")
	weldBetween(DummyHead,BLOOD)
	local BLOOD = CreatePart(3, Torso2, "Neon", 0, 0, "New Yeller", "Blood", VT(0.65,0.2,0.65),false)
		...
		if HITFLOOR.Parent ~= Weapon and HITFLOOR.Parent ~= Character then
			if HITFLOOR.Name == "BloodPuddle" then
				...
				if HITFLOOR.Anchored == true then
					local BLOOD = CreatePart(3, Effects, "Neon", 0, 0, "New Yeller", "BloodPuddle", VT(1,0,1))
...
function SprayBlood(POSITION,DIRECTION,BloodSize)
	local BLOOD = CreatePart(3, Effects, "Marble", 0, 0, "New Yeller", "BloodPuddle", VT(0.5,0.5,0.5),false)
...
function Laugh()
	ATTACK = true
	Rooted = true
	CreateSound("749031341", Torso, 1, 0.8)
...
tecks2.TextStrokeColor3 = Color3.new(255, 255, 0)
...
while true do
	...
	if Head:FindFirstChild("face") then
		Head.face.Texture = "http://www.roblox.com/asset/?id=620880861"
	end
	...
	if math.random(1,70-Speed) == 1 then
		tecks2.Text = "Eat Your Fruits!"
	elseif math.random(1,70-Speed) == 2 then
		tecks2.Text = "Yummy Banana!!!"
	elseif math.random(1,70-Speed) == 3 then
		tecks2.Text = "Banana Splat!"
	else
		if KILLINSTINCT > 0 then
